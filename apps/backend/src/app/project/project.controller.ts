...
import { DomainExceptions, Project } from '@delia/backend/project';
...
import { exceptions as PlanExceptions } from '@delia/backend/plan';
...
import { PlanUpdaterInjectable } from './plan/plan.application.proxy';
import { exceptions as TeamExceptions } from '@delia/backend/team';
import { exceptions as ProcessExceptions } from '@delia/backend/process';
import { exceptions as GutExceptions } from '@delia/backend/gut';
import { exceptions as QAExceptions } from '@delia/backend/qa';
import { exceptions as ProjectExceptions } from '@delia/backend/project';
import {
...
export class ProjectController {
  constructor(
    private projectCreator: ProjectCreatorInjectable,
    private planCreator: PlanCreatorInjectable,
    private processCreator: ProcessCreatorInjectable,
    private gutCreator: GutCreatorInjectable,
    private qaCreator: QACreatorInjectable,
    private teamCreator: TeamCreatorInjectable,
    private projectUpdater: ProjectUpdaterInjectable,
    private projectFinderByParam: ProjectFinderByParamInjectable,
    private projectFinderAll: ProjectFinderAllInjectable,
    private teamFinder: TeamFinderInjectable,
    private teamUpdater: TeamUpdaterInjectable,
    private planUpdater: PlanUpdaterInjectable,
    private processUpdater: ProcessUpdaterInjectable,
    private qaUpdater: QAUpdaterInjectable,
    private gutUpdater: GutUpdaterInjectable,
    private planFinder: PlanFinderInjectable,
    private processFinder: ProcessFinderInjectable,
    private qaFinder: QAFinderInjectable,
    private gutFinder: GutFinderInjectable,
    private projectFinderAllByAccountId: ProjectFinderAllByAccountIdInjectable
  ) {}
  ...
  async findAll(
    ...
    const response = await this.projectFinderAll.run(query);
